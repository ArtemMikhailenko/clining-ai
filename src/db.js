...
const DEFAULT_FACTS = [
  ...
  'Работаем по всей стране, приоритетная зона Ашдод - Хадера. Выезд обсуждается с менеджером.',
...
const LEGACY = {
  system_prompt: ['26de0a12bb145470', 'a9c5722304df87fb', '00be20aa4629945c'],
  greeting: ['a6e77eadcb2e6ac0'],
  business_facts: ['9fa01d5721b12cc7', '9f58cbaa33cc3f94', '40de58dc7e5046b9'],
