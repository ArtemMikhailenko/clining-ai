...
const LABELS = { service:'Тип уборки', object_type:'Объект', area_m2:'Площадь, м²', rooms_count:'Комнат',
  bathrooms:'Санузлов', district:'Район', date:'Дата', windows:'Мыть окна', condition:'Загрязнение',
...
const EDITABLE = [
  ...
  ['stage', 'Стадия', 'select', ['', 'новый', 'уточняем', 'назвали цену', 'готов к заказу', 'дата согласована', 'отказ']]
];
...
function renderSettings() {
  ...
  const sec = {
    ...
    bot: {
      ...
      body: grp('Приветствие', 'Первое сообщение в каждом новом диалоге. По строке на язык в формате <code>uk: текст</code> — нужная выбирается по языку клиента. Раскрытие того, что отвечает ИИ, требуют правила WhatsApp с 15.01.2026.',
